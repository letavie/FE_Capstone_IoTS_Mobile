  ...
  const handleAddToCart = async () => {
    if (!device || device.quantity <= 0) {
      Toast.show({
        type: "error",
        text1: "Out of stock",
        text2: "The product is currently unavailable",
      });
      return;
    }
    try {
      ...
      Toast.show({
        type: "success",
        text1: "Added to cart",
        text2: ` device has been added to your cart`,
      });
          ...
          <View className="flex-row">
            {[...Array(5)].map((_, i) => (
              <SafeStarIcon
                ...
                size={16}
                color={
                  i < item.rating ? colors.primary : colors.mutedForeground
                }
              />
            ))}
          </View>
        ...
        {(deviceNonNull.weight ||
          ...
          <View className="mb-4">
            ...
            <View className="flex-row flex-wrap">
              {deviceNonNull.weight !== undefined &&
                deviceNonNull.weight !== null && (
        ...
        {deviceNonNull.deviceSpecificationsList &&
          deviceNonNull.deviceSpecificationsList.length > 0 && (
            <View className="mb-4">
              ...
              {deviceNonNull.deviceSpecificationsList.map(
                (specGroup, index) => (
          ...
          <View className="flex-row justify-between mb-4">
            <View>
              ...
              <Text
                ...
                style={{
                  color:
                    device.quantity > 0 ? colors.primary : colors.destructive,
                }}
              >
          ...
          >
            ...
            <View className="flex-row mt-4">
              ...
              <TouchableOpacity
                onPress={() =>
                  router.push(
                    `/store/ProfileStore?storeId=${device.storeInfo.id}`
                  )
                }
        ...
        >
          ...
          >
            <Text
              ...
              style={{
                color:
                  activeTab === "details" ? colors.primary : colors.foreground,
              }}
            >
              Details
            </Text>
          ...
          >
            <Text
              ...
              style={{
                color:
                  activeTab === "reviews" ? colors.primary : colors.foreground,
              }}
            >
              Reviews
            </Text>
      ...
      >
        <View className="flex-row items-center justify-between mb-4">
          ...
          <View className="flex-row items-center">
            ...
            <TouchableOpacity
              onPress={() =>
                setQuantity(Math.min(device.quantity || 10, quantity + 1))
              }
              className="p-2 rounded-lg border"
              style={{ borderColor: colors.border }}
            >
