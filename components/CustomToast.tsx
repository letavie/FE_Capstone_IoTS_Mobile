import { BaseToast, ErrorToast, SuccessToast, InfoToast, BaseToastProps } from 'react-native-toast-message';
...
export const toastConfig = {
  success: (props: BaseToastProps) => ( // Add type for props
    <SuccessToast
      {...props}
  ...
  error: (props: BaseToastProps) => ( // Add type for props
    <ErrorToast
      {...props}
      style={toastStyles.container}
      text1Style={toastStyles.text1}
  ...
  info: (props: BaseToastProps) => ( // Add type for props
    <InfoToast
      {...props}
      style={toastStyles.container}
      text1Style={toastStyles.text1}
